package com.jbo5068_bw.ist402.accsimtesting;
...
public class AccelerometerPlayActivity extends ActionBarActivity {
    ...
    //for the time being, keep this largely the same
